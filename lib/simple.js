...
simple.res = {};
simple.server = {};
simple.use = function(handler) {
    if (arguments[0] instanceof Function && arguments.length == 1) {
        //TODO
    } else
    if (typeof arguments[0] === 'string' && arguments[1] instanceof Function) {
        simple.router.get(arguments[0], arguments[1], arguments[2]);
    } else {
        console.log("simple.use not correct arguments !");
    }
}
